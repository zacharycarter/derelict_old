...
public class HallwayPathFinderDodgeRooms extends AStarPathFinder2d {

    GridMap gridMap;
    Spacecraft spacecraft;

    public HallwayPathFinderDodgeRooms(GridMap map, int maxSearchDistance, boolean allowDiagMovement, Spacecraft spacecraft) {
    ...
    /**
     * @see PathFinder2d#findPath(Mover2d, int, int, int, int)
     */
    @Override
