...
public class MonsterOld extends CharacterOld {
    ...
    public MonsterOld(long id, WorldOld world, int speed, AnimationComponent animationComponent, Vec2I position) {
    ...
    @Override
    public int act() {
        System.out.println("Actor " + getId() + " acting!");
