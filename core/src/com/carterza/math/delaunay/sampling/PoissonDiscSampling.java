...
package com.carterza.math.delaunay.sampling;
...
import com.carterza.utilities.random.Random;
...
public class PoissonDiscSampling implements PointSampling {
    ...
    public List<Vector2f> create(Rect2f bounds, int numSites, Random rng) {
        ...
        List<Vector2f> points = new ArrayList<Vector2f>(numSites);
        List<Vector2f> cells = new ArrayList<Vector2f>(numSites);
