...
package com.carterza.math.delaunay.graph;
...
public class VoronoiGraph implements Graph {
    ...
    public VoronoiGraph(Rect2i bounds, Voronoi v) {
        ...
        final Map<Vector2f, Region> regionMap = new HashMap<Vector2f, Region>();
        final Map<BaseVector2f, Corner> pointCornerMap = new HashMap<BaseVector2f, Corner>();
        ...
        for (com.carterza.math.delaunay.Edge libedge : v.edges()) {
