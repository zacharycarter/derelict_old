...
public class AStarPathFinder2d implements PathFinder2d {
     ...
     */
    protected ArrayList<PathNode2d> closed = new ArrayList<PathNode2d>();
    /**
     * The set of nodes that we do not yet consider fully searched
     */
    protected PriorityQueue<PathNode2d> open = new PriorityQueue<PathNode2d>();

    /**
     * The map being searched
     */
    protected TileBasedMap2d map;
    /**
     * The maximum depth of search we're willing to accept before giving up
     */
    protected int maxSearchDistance;

    /**
     * The complete set of nodes across the map
     */
    protected PathNode2d[][] nodes;
    /**
