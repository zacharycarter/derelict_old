...
public class Condition {
    ...
    public Condition(net.bytten.metazelda.Condition other) {
        this.keyLevel = other.getKeyLevel();
        if(other.getSwitchState() == net.bytten.metazelda.Condition.SwitchState.EITHER)
            this.switchState = SwitchState.EITHER;
        else if (other.getSwitchState() == net.bytten.metazelda.Condition.SwitchState.ON)
                this.switchState = SwitchState.ON;
        else if (other.getSwitchState() == net.bytten.metazelda.Condition.SwitchState.OFF)
     ...
     */
    public Condition(int keyLevel, SwitchState switchState) {
        keyLevel = 0;
